 ...
 * PathwaysAbundance
 *
 * @ORM\Table(name="pathways_abundance")
 * @ORM\Entity(repositoryClass="App\Repository\PathwaysAbundanceRepository")
 */
class PathwaysAbundance
{
    /**
     * @var int
     *
     ...
     * @var string|null
     *
     * @ORM\Column(name="pathways", type="string", length=255, nullable=true)
     */
    private $pathways;
    ...
    public function getPathways(): ?string
    {
        return $this->pathways;
    }

    public function setPathways(?string $pathways): self
    {
